...
$ # 在 centos-10 节点上重启 ceph-mon
$ systemctl restart ceph-mon@centos-10.service

$ # 在 centos192 节点上重启 ceph-radosgw
$ systemctl restart ceph-radosgw@rgw.centos192.service
```
...
$ ceph health
$ ceph health detail
HEALTH_WARN mon Yin is low on available space
MON_DISK_LOW mon Yin is low on available space
    mon.Yin has 29% avail
...
$ ceph osd crush rm centos-13 # 删除一个 osd 的 host 节点
